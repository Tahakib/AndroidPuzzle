       ...
       // textView=(TextView)findViewById(R.id.textView);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(), "You have already tried to answer a Question!", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    openyoutube();
    ...
    private static void display(Context context) {
        ...
        for (int i = 0; i < tileList.length; i++) {
            ...
            if (tileList[i].equals("0"))
                button.setBackgroundResource(R.drawable.war_1);
            else if (tileList[i].equals("1"))
                button.setBackgroundResource(R.drawable.war_2);
            else if (tileList[i].equals("2"))
                button.setBackgroundResource(R.drawable.war_3);
            else if (tileList[i].equals("3"))
                button.setBackgroundResource(R.drawable.war_4);
            else if (tileList[i].equals("4"))
                button.setBackgroundResource(R.drawable.war_5);
            else if (tileList[i].equals("5"))
                button.setBackgroundResource(R.drawable.war_6);
            else if (tileList[i].equals("6"))
                button.setBackgroundResource(R.drawable.war_7);
            else if (tileList[i].equals("7"))
                button.setBackgroundResource(R.drawable.war_8);
            else if (tileList[i].equals("8"))
                button.setBackgroundResource(R.drawable.war_9);
